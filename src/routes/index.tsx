...
import { shops, products, categories, cities, formatLKR, findShop } from "@/lib/data";
...
function Index() {
  ...
  const trusted = shops.filter((s) => s.sellerType !== "new").slice(0, 4);
  ...
  return (
    <div>
      ...
      <Section
        ...
        title="Shop everything, from a real shop"
      >
          ...
          {trusted.map((s) => (
            ...
            >
              <div
                ...
                style={{
                  background: `oklch(0.92 0.06 ${s.logoHue})`,
                  color: `oklch(0.35 0.13 ${s.logoHue})`,
                }}
              >
          ...
          <div className="grid items-center gap-8 md:grid-cols-2">
            <div>
              ...
              <p className="mt-3 max-w-md text-background/70">
                Whether you run a shop in Pettah, sell on WhatsApp, or you're just starting out — we'll
